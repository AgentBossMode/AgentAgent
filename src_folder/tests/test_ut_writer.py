...
from src_folder.tests.test_utils.nutrition_agent_files.nutrition_req_analysis import nutrition_dry_runs
...
async def test_pytest_writer():
    ...
    utgenerated: UtGeneration = await generate_ut_llm_call(DryRuns.model_validate_json(nutrition_dry_runs), nutrition_agent_code, nutrition_mock_tools_code)
